...
//     // Initialize charts
//     createChart(document.getElementById('lhcChart').getContext('2d'), [150, 300, 450, 500, 450, 300, 150]);
//     createChart(document.getElementById('apexChart').getContext('2d'), [30, 40, 50, 60, 50, 40, 30]);
//     createChart(document.getElementById('esbChart').getContext('2d'), [200, 400, 500, 550, 500, 400, 200]);
